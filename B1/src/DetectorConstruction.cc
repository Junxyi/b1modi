...
namespace B1
{
  ...
  G4VPhysicalVolume *DetectorConstruction::Construct()
  {
    ...
    // Envelope parameters
    //
    G4double env_sizeXY = 20 * um, env_sizeZ = 30 * um;
    // G4Material *env_mat = nist->FindOrBuildMaterial("vac");
    ...
    // G4Material *world_mat = nist->FindOrBuildMaterial("vac");
    ...
    G4ThreeVector pos2 = G4ThreeVector(0, 0 * um, 7 * um);

    // Trapezoid shape
    G4double shape2_dxa = 12 * um, shape2_dxb = 12 * um;
    G4double shape2_dya = 10 * um, shape2_dyb = 16 * um;
    G4double shape2_dz = 6 * um;
    G4Trd *solidShape2 =
