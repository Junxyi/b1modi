...
namespace B1
{
  ...
  RunAction::RunAction()
  {
    ...
    // analysisManager->CreateH1("Eabs", "Edep in absorber", 100, 0., 100);
    analysisManager
        ->CreateH1("Total energy", "Totaleng", 50, 0., 150); // h1 Id = 0
    analysisManager
        ->CreateH1("Kinetic energy", "Totaleng", 50, 0., 150); // h1 Id = 1
